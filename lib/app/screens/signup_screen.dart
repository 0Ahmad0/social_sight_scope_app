            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style:
                      StyleManager.font40Bold(color: ColorManager.whiteColor),
                ),
                verticalSpace(20.h),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppTextField(
                        ...
                        validator: (value) =>
                            authController.validateConfirmPassword(value ?? '',
                                authController.passwordController.value.text),
                        hintText:
                            tr(LocaleKeys.signup_enter_confirm_password_text),
                      ),
                      verticalSpace(30.h),
                      AppButton(
                        onPressed: () {
                      ...
                      Align(
                        ...
                        child: Text.rich(
                          ...
                          TextSpan(children: [
                            TextSpan(
                                text: tr(LocaleKeys
                                    .signup_have_already_account_text)),
                            TextSpan(
